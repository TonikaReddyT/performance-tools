...
def _generate_cameras_override(app_dir: str, num_scenes: int) -> None:
    ...
    with open(override_path, "w") as f:
        f.write("# Auto-generated by swlpstream_density.py — do not edit\n")
...
class SADStreamDensity:
    ...
    def _print_header(self) -> None:
        print("=" * 70)
        print("SWLP Stream Density – Scene-Based Latency Scaling")
        print("=" * 70)
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="SWLP Stream Density Benchmark",
